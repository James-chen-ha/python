# -*- coding: utf-8 -*-
"""
Created on Wed Apr 29 16:00:01 2020
...
#y=X_train
#X=Y_train
clf = SVR(kernel='rbf', C=1e3, gamma=0.1)#將SVR演算法引入到clf，並設定SVR演算法的參數
clf.fit(X_train, Y_train)
#from sklearn.externals import joblib
#joblib.dump(clf,r'C:\Users\Lab408\Desktop\try_model_ashrae_energy_prediction_kaggle\machine_SVR.pkl')
#使用joblib.dump將SVR預測器匯出為pkl檔
#clf=joblib.load(r'C:\Users\Lab408\Desktop\try_model_ashrae_energy_prediction_kaggle\machine_SVR.pkl')
#接著使用clf=joblib.load("./machine_SVR.pkl")將pkl檔匯入為一個SVR預測器clf
#clf.fit(X_train, X)
